...
<% 
	...
	try {
		...
		db.preparedStatement = db.connection.prepareStatement("select * from product");
        ...
        <div class="col-md-4 mt-2">
            <div class="card">
                ...
                <div class="card-body bg-light text-center">
                    ...
                    <a  href="../action/update_product.jsp?id=<%=pid %>" class="btn bg-cart"><i class="fa fa-cart-plus mr-2"></i> Add to cart</a>
                </div>
            </div>
        </div>
