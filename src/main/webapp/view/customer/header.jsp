...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
		<a class="navbar-brand ml-2 mr-1" href="#" ><%=email %> </a>
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item active "><a class="nav-link" href="Mycart.jsp">My Cart </a></li>		
				<li class="nav-item active"><a class="nav-link" href="myorder.jsp">My Orders</a></li>
			...
			<form class="form-inline my-2 my-lg-0" method="post" action="../action/search.jsp">
				<input class="form-control mr-sm-2 ml-1 px-2" type="search" size="5px" name="s" id="s"
					placeholder="Search">
