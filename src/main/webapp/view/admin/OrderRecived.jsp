...
<%
  ...
  int tid = 0 ;
	try {
		...
		db.preparedStatement = db.connection.prepareStatement("select * from orders");
  ...
  %>
		<tbody>
			<tr>
				...
				<td><%=status %></td>
				<td><%=total %></td>
				<td><a href="../action/deliverd.jsp?tid=<%=tid%>">Delivered</a></td>
				<td><a href="../action/canceled.jsp?tid=<%=tid%>">Canceled</a></td>
			</tr>
