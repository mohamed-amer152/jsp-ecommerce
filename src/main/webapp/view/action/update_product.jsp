...
try {
	...
	db.preparedStatement = db.connection.prepareStatement("select * from product where id =?");
...
<body>
	...
	<div class="wrapper">
		...
		<div class="text-center mt-4 name">Update Product</div>
		<form class="p-3 mt-3" action="../action/update_product_action.jsp?pid=<%=id%>" method="post">
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="pname" value="<%=name%>"
					id="pname" placeholder="Product Name ">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="price"  value="<%=price %>"
					id="price" placeholder="Product Price">
			</div>
			<div class="form-field d-flex align-items-center">
				<span class="far fa-user"></span> <input type="text" name="active" value="<%=active %>"
